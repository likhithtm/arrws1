...
<div itemscope itemtype="http://schema.org/Product">
  ...
  <div class="product-info">
  	<div class="row">
             <!-- <center><a target="_blank" href="http://gccworld.info/doc/venturo/"><b><u>Theme Installation Error: Delete Cache or Re-Download and re-upload or check documentation here</u></b></a></center> -->
			     ...
			     <div id="product">
                                ...
                                <script>
                                    $(document).ready(function () {
                                        $("#chk_all").click(function () {
                                            $(".chk_separate").prop('checked', $(this).prop('checked'));
                                        });
                                    });
                                </script>
     			        ...
     			        <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
     			          ...
     			          <div id="input-option<?php echo $option['product_option_id']; ?>">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if($option['product_option_value']) { $span_id = 0; foreach ($option['product_option_value'] as $option_value) { $option_value['span'] = $span_id; ?>

                                                <tr>
                                                    <!-- <div class="checkbox <?php if($theme_options->get( 'product_page_checkbox_style' ) == 1) { echo 'radio-type-button2'; } ?>"> -->

                                                    <td><input type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="chk<?php echo $option_value['option_value_id']  ?>"/></td>
                                                        <td><?php echo $option_value['name']; ?></td>
                                                        <td><?php if($theme_options->get( 'product_page_checkbox_style' ) != 1) { ?><?php if ($option_value['price']) { ?>
                                                        (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
                                                        <?php } ?><?php } ?></td>
                                                        <td><?php echo $option_value['quantity']; ?></td>
                                                        <td><input type="text" name="quantity[<?php echo $option['product_option_id']; ?>][]" size="1" id="quantity<?php echo $option_value['product_option_value_id']; ?>"  value="0" readonly="true" class="form-control"/>
                                                            <span id="span<?php echo $option_value['span']; ?>" style="color: #ff4d4d"></span>
                                                        </td>

                                                    <!-- </div> -->
                                                    <script>
                                                        
                                                        $('input[value="<?php echo $option_value['product_option_value_id']; ?>"]').click(function(){
                                                            var aa = $('#quantity<?php echo $option_value['product_option_value_id']; ?>').val();
                                                        //alert(aa);
                                                            if($(this).prop("checked") == true){
                                                                //alert("Please enter Quantity");
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').prop('readonly', false);
                                                                $('#span<?php echo $option_value['span']; ?>').text('Enter Qty value > 0');
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').focus();
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').css('border-color', 'blue');
                                                                
                                                                //called when key is pressed in textbox
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').keypress(function (event) {
                                                                    $(this).val($(this).val().replace(/[^0-9\.]/g,''));
                                                                    if ((event.which != 46 || $(this).val().indexOf('.') != -1) && (event.which < 48 || event.which > 57)) {
                                                                        event.preventDefault();
                                                                        $('#span<?php echo $option_value['span']; ?>').html("Please Enter Digits Only").show();
                                                                    }
                                                                });
                                                            }
                                                            else {
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').prop('value', 0);
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').prop('readonly', true);
                                                                $('#span<?php echo $option_value['span']; ?>').text('');
                                                                $('#quantity<?php echo $option_value['product_option_value_id']; ?>').css('border-color', '');
                                                            }
                                                        });
                                                        $(document).ready(function(){
                                                           $("#quantity<?php echo $option_value['product_option_value_id']; ?>").keypress(function(){
                                                    ...
                                                    <?php $span_id++; }  } else { ?>
                                                    <?php  ?>
                                                    <tr><td colspan="5" style="text-align: center;">Out of stock</td></tr>
                                                    <?php }  ?>
                                            </tbody>
                                        </table>
			      ...
			      <div class="cart">
			        ...
			        <div class="links clearfix">
			        	<ul>
                        <li>
                        <a onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart-o"></i><?php if($theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to wishlist'; } ?></a></li>
			        	<li><a onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-refresh"></i><?php if($theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to compare'; } ?></a></li></ul>
        ...
        <div class="collapse" id="collapseAskaQ">
          <form style="margin-top: 15px; margin-bottom: 15px;" method="post" id="form-questions">
            <fieldset>
              ...
              <div class="form-group required">
                <label class="control-label" for="input-questions">Question?</label>
              ...
              <input type="hidden" name="prod_url" value="<?php echo $product_url; ?>" />
            </fieldset>
            <p class="help-block"><span style="color:red;">*</span> Required</p>
            <div style="text-align: center">
              <button id="button-questions" type="button" class="btn btn-primary">Ask?</button>
            </div>
          </form>
          <script type="text/javascript"><!--
...
$('#button-cart').on('click', function() {
	...
	$.ajax({
		...
		type: 'post',
		data: $('#product input[type=\'text\'], #product input[type=\'hidden\'], #product input[type=\'radio\']:checked, #product input[type=\'checkbox\'], #product select, #product textarea'),
		dataType: 'json',
		beforeSend: function() {
